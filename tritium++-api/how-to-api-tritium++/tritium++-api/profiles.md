...
This will create a crypto object register for login auth for signature chains created with Tritium, for use with Tritium++. Existing users need to run this API to convert their Tritium accounts to be compatible with Tritium++ profiles. The interface wallet will do this automatically.
