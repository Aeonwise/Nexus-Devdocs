...
[`create/account`](finance-methods.md#create-account)\
...
`create/token`\
`debit/token`\
[`credit/token`](finance-methods.md#credit-token)\
[`get/token`](finance-methods.md#get-token)\
[`burn/token`](finance-methods.md#burn-token)\
[`list/token/transactions`](finance-methods.md#list-token-transactions)\
[`list/token/accounts`](finance-methods.md#list-token-accounts)\
[`get/stakeinfo`](finance-methods.md#get-stakeinfo)\
[`set/stake`](finance-methods.md#set-stake)\
[`migrate/accounts`](finance-methods.md#migrate-accounts)\
[`get/balances`](finance-methods.md#get-balances)\
[`list/balances`](finance-methods.md#list-balances)\
[`list/trustaccounts`](finance-methods.md#list-trustaccounts)
